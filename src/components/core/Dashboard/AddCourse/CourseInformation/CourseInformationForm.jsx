...
export default function CourseInformationForm() {
  ...
  return (
    <form
      onSubmit={handleSubmit(onSubmit)}   //handle submit is a method provided ny react-hook-form for handling validation and submission ,takes function which handles
      //  form submission as input 
