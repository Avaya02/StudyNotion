  ...
  const [active, setActive] = useState(1)
    ...
    useEffect(() => {
        const getCategoryDetails = async() => {
            try{
                if (!categoryId) return; // Only make API call if categoryId is available
                console.log("Debug");
        ...
        // if(categoryId) {   //at making direct function call it was giving error so we put a condition and then invoked the function 
            getCategoryDetails();
        // }
